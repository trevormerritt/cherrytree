...
{
    int cmp = _pCtMainWin->curr_tree_store().to_ct_tree_iter(leftIter).get_node_name().compare(_pCtMainWin->curr_tree_store().to_ct_tree_iter(rightIter).get_node_name());
